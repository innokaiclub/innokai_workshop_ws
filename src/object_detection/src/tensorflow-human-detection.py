...
if __name__ == "__main__":
    rospy.init_node('tensorflow-human-detection', anonymous=True)
    pub = rospy.Publisher('cmd_vel', Twist, queue_size=5)
    rospy.sleep(2)
    cv_bridge = CvBridge()
    model_path = '/home/zimbot/innokai_workshop_ws/src/object_detection/src/faster_rcnn_inception_v2_coco_2018_01_28/frozen_inference_graph.pb'
